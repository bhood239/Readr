...
const App = () => {
    ...
    const { handlePostByUserIdAndBookId } = usePostByUserIdAndBookId(currentUser);
    const { bookStatuses: allBookStatuses, loading, error } = useAllBookStatuses(currentUser);
    const [loginSelected, setLoginSelected] = useState(false);
    const [registerSelected, setRegisterSelected] = useState(false);
    const { posts: initialPosts, loading: postsLoading, error: postsError } = useAllPosts(currentUser); // Fetch initial posts
