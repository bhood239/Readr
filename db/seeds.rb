...
user5 = User.create!(name: "Ben Hood", email: "bhood239@gmail.com", password: "password", profile_pic: "/images/ben-profile.jpg")
user6 = User.create!(name: "Vyshnavi Doulagar", email: "v.d@example.com", password: "password", profile_pic: "/images/vyshnavi-profile.jpg")
...
BookStatus.create!(status: "read", fave_books: true, book_id: "OL27482W", user_id: user5.id)
BookStatus.create!(status: "reading", fave_books: false, book_id: "OL40235949M", user_id: user5.id)
BookStatus.create!(status: "to_read", fave_books: false, book_id: "OL43304516M", user_id: user5.id)

BookStatus.create!(status: "read", fave_books: true, book_id: "OL82536W", user_id: user6.id)
BookStatus.create!(status: "to_read", fave_books: false, book_id: "OL30946736W", user_id: user6.id)
BookStatus.create!(status: "to_read", fave_books: false, book_id: "OL21984600W", user_id: user6.id)
BookStatus.create!(status: "reading", fave_books: true, book_id: "OL20651342W", user_id: user6.id)
...
Post.create!(rating: 5, review: "Absolutely MAGICAL", time_spent: 200, book_id: "OL27482W", user_id: user5.id)
...
Post.create!(rating: 5, review: "One of my faves. All time top quality book", time_spent: 120, book_id: "OL40235949M", user_id: user5.id)
...
Post.create!(rating: 1, review: "Don't see what all the commotion is about.", time_spent: 150, book_id: "OL43304516M", user_id: user5.id)
...
Post.create!(rating: 3, review: "Not the biggest fan of this, took too long to read!", time_spent: 500, book_id: "OL7885696M", user_id: user5.id)

# Create friends
Friend.create!(follower_id: user1.id, following_id: user2.id)
Friend.create!(follower_id: user1.id, following_id: user6.id)
Friend.create!(follower_id: user1.id, following_id: user5.id)
...
Friend.create!(follower_id: user5.id, following_id: user1.id)
Friend.create!(follower_id: user5.id, following_id: user2.id)
Friend.create!(follower_id: user5.id, following_id: user3.id)